                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" action="{{ route('products.store') }}" method="post" novalidate
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-words="2" name="name"
                                                    placeholder="Sumsung" required="required" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-words="2"
                                                    name="count_in_stock" placeholder="count" required="required" />
                                            </div>
                                        </div>
