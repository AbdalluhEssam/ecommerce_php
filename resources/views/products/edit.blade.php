                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="images/img.jpg" alt="">Abdalluh Essam
                                </a>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add Products <small>First</small></h2>
                                ...
                                <div class="x_content">
                                    <form action="{{ route('products.update', $products->id)}}" method="post" novalidate
                                        ...
                                        <img src="{{ asset('storage/images/'.$products->image) }}" height="150">
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Name<span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-words="2" name="name"
                                                    value="{{ $products->name }}" placeholder="Sumsung"
                                                    required="required" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">price<span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-words="2" name="price"
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">count
                                                stock<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-words="2"
                                                    value="{{ $products->count_in_stock }}" name="count_in_stock"
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Brand Id
                                                <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <select name="barnd_id" class="form-control">

                                                    @foreach($brands as $brand)
                                                    <option selected value="{{ $products->barnd_id }}">
                                                        {{ $brand->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
